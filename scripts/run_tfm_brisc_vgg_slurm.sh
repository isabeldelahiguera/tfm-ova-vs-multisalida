...
BRISC_ROOT="${BRISC_ROOT:-/mnt/homeGPU/imhiguera/data/brisc2025}"
...
python run_experiments.py \
  ...
  --output-csv "resultados_slurm/exp_brisc_${MODEL_ARCH}_${IMAGE_SIZE}_${JOB_ID}.csv" \
  --summary-csv "resultados_slurm/exp_brisc_${MODEL_ARCH}_${IMAGE_SIZE}_${JOB_ID}_summary.csv"
